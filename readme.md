...
| Enchantress                   | Preset Spells                                | It's not possible to directly class into the Overclasses at this point as far as I know, so you'd have to be a Saint to progress into this class line. So from my research it |
| Guru                          | Preset Spells                                | Similar to the Enchantress, it's not possible to directly class into the Overclasses at this point as far as I know. When you class into Guru, you will gain access to the Guru's standard Lemegeton white magic. |
...
| Exemplar                      | Preset Spells                                | It's not possible to directly class into the Overclasses at this point as far as I know, so you'd have to be a Saint to progress into this class line. So from my research it |
| Harrier                       | Preset Spells                                | Similar to other overclassed castors. Harriers will allways learn Fire. |
