...
7. Unfortunately, you will still have to use NTR cheats to promote classes. Check the [Reclassing/Promoting Using romfs](#Reclassing/Promoting-using romfs:) section.
