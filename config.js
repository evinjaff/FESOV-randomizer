...
function chooseclass(level, yesamiibo, yesenemy, yesbroken, yesalm, yestier1) {
	...
	var enemyone = [];
	var enemyflex = ["Brigand", "Arcanist", "Cantor", "Witch"];
	...
	var brokenuni = ["Fell Dragon", "God", "Player Boat", "Enemy Boat"];
	var uglyone = ["Gargoyle", "Lich", "Entombed", "Entombed (Normal)", "Revenant", "Mogall"];
	var uglythree = ["Deathgoyle", "Gardua", "Deimos", "Vestal"];
	var uglytwo = ["Entombed (Numbing)", "Entombed (Venin)", "Titan", "Lich", "Necodragon", "Fafnir", "Bonewalker"];
	var classledger = [];
	if (level == 1) {
